...
void FreeStanding()
{
	...
	if (!autowalld || (bside1 && bside2)) {
		...
		case MovingAAType::Standing: {
			...
			case 5: Globals::pCmd->viewangles.y += Globals::Manual_Side ? 90 : -90; break;
			case 6: Globals::pCmd->viewangles.y += c_config::get().custom_yaw_stand; break;
			}
			switch (c_config::get().yaw_standing_add) {
			case 0:
				break;
			case 1:
			{
				...
				{
				case 0:
					Globals::pCmd->viewangles.y += c_config::get().yaw_standing_add_angle;
					mode++;
					break;
			...
			case 3:
			{
				Globals::pCmd->viewangles.y += fmodf(g_pGlobalVars->curtime * c_config::get().spin_speed_stand, c_config::get().yaw_standing_add_angle);
				break;
			}
			case 4:
				Globals::pCmd->viewangles.y += RandomFloat(-c_config::get().yaw_standing_add, c_config::get().yaw_standing_add_angle);
				break;
			}
		}break;
		case MovingAAType::Moving: {
			...
			case 4: Globals::pCmd->viewangles.y += Globals::Manual_Side ? 90 : -90; break;
			case 5: Globals::pCmd->viewangles.y += Globals::Manual_Side ? 90 : -90; break;
			case 6: Globals::pCmd->viewangles.y += c_config::get().custom_yaw_move; break;
			}
			switch (c_config::get().yaw_moving_add) {
			case 0:
				break;
			case 1:
			{
				...
				{
				case 0:
					Globals::pCmd->viewangles.y += c_config::get().yaw_moving_add_angle;
					mode++;
					break;
			...
			case 3:
			{
				Globals::pCmd->viewangles.y += fmodf(g_pGlobalVars->curtime * c_config::get().spin_speed_move, c_config::get().yaw_moving_add_angle);
				break;
			}
			case 4:
				Globals::pCmd->viewangles.y += RandomFloat(-c_config::get().yaw_standing_add, c_config::get().yaw_moving_add_angle);
				break;
			}
		}break;
		case MovingAAType::Air: {
			...
			case 3: Globals::pCmd->viewangles.y += g_pGlobalVars->curtime * 3000; break;
			case 4: Globals::pCmd->viewangles.y += Globals::Manual_Side ? 90 : -90; break;
			case 6: Globals::pCmd->viewangles.y += c_config::get().custom_yaw_air; break;
			}
			switch (c_config::get().yaw_air_add) {
			case 0:
				break;
			case 1:
			{
				...
				{
				case 0:
					Globals::pCmd->viewangles.y += c_config::get().yaw_air_add_angle;
					mode++;
					break;
			...
			case 3:
			{
				Globals::pCmd->viewangles.y += fmodf(g_pGlobalVars->curtime * c_config::get().spin_speed_air, c_config::get().yaw_air_add_angle);
				break;
			}
			case 4:
				Globals::pCmd->viewangles.y += RandomFloat(-c_config::get().yaw_standing_add, c_config::get().yaw_air_add_angle);
				break;
			}
		}break;
		}
...
void Real()
{
	...
	if (!Globals::bSendPacket && Globals::LocalPlayer->AnimState() && c_config::get().desync > 0) {
		if (c_config::get().desync == 1) {
		...
		else if (c_config::get().desync == 5) {
			if (c_config::get().desync_switch_enable) {
				if (stage == 1) {
					Globals::pCmd->viewangles.y = g_Math.NormalizeYaw(Globals::RealAngle.y + 180 - c_config::get().desync_add);
					stage = 2;
				}
				if (stage == 2) {
					Globals::pCmd->viewangles.y = g_Math.NormalizeYaw(Globals::RealAngle.y + 180 + c_config::get().desync_add);
		...
		else if (c_config::get().desync == 6) {
			if (c_config::get().desync_switch_enable) {
				if (stage == 1) {
					Globals::pCmd->viewangles.y = g_Math.NormalizeYaw(Globals::RealAngle.y + 58);
					stage = 2;
				}
				if (stage == 2) {
					Globals::pCmd->viewangles.y = g_Math.NormalizeYaw(Globals::RealAngle.y - 58);
			...
			{
				Globals::pCmd->viewangles.y = g_Math.NormalizeYaw(Globals::RealAngle.y + Globals::Manual_Side ? -58 : 58);
			}
		}
		else if (c_config::get().desync == 7) {
			float fake = RandomFloat(45, -45);
			float fake2 = RandomFloat(40, -40);
			Globals::pCmd->viewangles.y = Globals::RealAngle.y + 180 + fake;
		}
	}
	else {
...
void AntiAim::OnCreateMove()
{
	...
	case MovingAAType::Standing: {
		...
		case 0:
			break;
		case 1: //back
			Globals::pCmd->viewangles.x = 82.f;
			break;
		case 2: //right
			Globals::pCmd->viewangles.x = 90.f;
			break;
		case 3://random
			Globals::pCmd->viewangles.x = -90.f;
			break;
		case 4://manual
			Globals::pCmd->viewangles.x = 0.f;
			break;
		case 5:
		{
			static int mode = 0;
		...
		case 6:
		{
			...
			case 1:
				Globals::pCmd->viewangles.x = 45.f;
				mode++;
				break;
		...
		case 9:
		{
			float pitch = fmodf(g_pGlobalVars->curtime * c_config::get().spin_speed_stand, 180.f);
			NormalizePitch(pitch);
			Globals::pCmd->viewangles.x = pitch;
			break;
		}
		case 10:
		{
			float pitch = -fmodf(g_pGlobalVars->curtime * c_config::get().spin_speed_stand, 90.f);
			NormalizePitch(pitch);
			Globals::pCmd->viewangles.x = pitch;
			break;
		}
		...
		case 12:
			Globals::pCmd->viewangles.x = RandomFloat(-90.f, 90.f);
			break;
		case 13:
		{
			static bool sbool = false;
		...
		break;
		case 16:
			Globals::pCmd->viewangles.x = 90.3f;
			break;
		case 17:
			Globals::pCmd->viewangles.x = -90.3f;
			break;
		case 18:
			Globals::pCmd->viewangles.x = c_config::get().custom_pitch_stand;
			break;
		}
	}break;
	case MovingAAType::Moving: {
		...
		case 9:
		{
			float pitch = fmodf(g_pGlobalVars->curtime * c_config::get().spin_speed_move, 180.f);
			NormalizePitch(pitch);
			Globals::pCmd->viewangles.x = pitch;
			break;
		}
		case 10:
		{
			float pitch = -fmodf(g_pGlobalVars->curtime * c_config::get().spin_speed_move, 90.f);
			NormalizePitch(pitch);
			Globals::pCmd->viewangles.x = pitch;
			break;
		}
		...
		case 17:
			...
			break;
		case 18:
			Globals::pCmd->viewangles.x = c_config::get().custom_pitch_move;
			break;
		}
	}break;
	case MovingAAType::Air: {
		...
		case 9:
		{
			float pitch = fmodf(g_pGlobalVars->curtime * c_config::get().spin_speed_air, 180.f);
			NormalizePitch(pitch);
			Globals::pCmd->viewangles.x = pitch;
			break;
		}
		case 10:
		{
			float pitch = -fmodf(g_pGlobalVars->curtime * c_config::get().spin_speed_air, 90.f);
			NormalizePitch(pitch);
			Globals::pCmd->viewangles.x = pitch;
			break;
		}
		...
		case 17:
			...
			break;
		case 18:
			Globals::pCmd->viewangles.x = c_config::get().custom_pitch_air;
			break;
		}
	}break;
	}
