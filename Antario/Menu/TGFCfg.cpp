...
void CConfig::Setup()
{
	...
	SetupValue(c_config::get().aimbot_headpointscale_auto, 0, "Aimbot", "aimbot_headpointscale_auto");
	SetupValue(c_config::get().aimbot_bodypointscale_auto, 0, "Aimbot", "aimbot_bodypointscale_auto");

	
	SetupValue(c_config::get().aimbot_headpointscale_scout, 0, "Aimbot", "aimbot_headpointscale_scout");
	SetupValue(c_config::get().aimbot_bodypointscale_scout, 0, "Aimbot", "aimbot_bodypointscale_scout");

	
	SetupValue(c_config::get().aimbot_headpointscale_awp, 0, "Aimbot", "aimbot_headpointscale_awp");
	SetupValue(c_config::get().aimbot_bodypointscale_awp, 0, "Aimbot", "aimbot_bodypointscale_awp");

	
	SetupValue(c_config::get().aimbot_headpointscale_heavy, 0, "Aimbot", "aimbot_headpointscale_heavy");
	SetupValue(c_config::get().aimbot_bodypointscale_heavy, 0, "Aimbot", "aimbot_bodypointscale_auto");
	
	SetupValue(c_config::get().aimbot_headpointscale_other, 0, "Aimbot", "aimbot_headpointscale_other");
	SetupValue(c_config::get().aimbot_bodypointscale_other, 0, "Aimbot", "aimbot_bodypointscale_other");
	...
	SetupValue(c_config::get().yaw_standing_add, 0, "Aimbot", "yaw_standing_add");
	SetupValue(c_config::get().yaw_standing_add_angle, 0, "Aimbot", "yaw_standing_add_angle");
	SetupValue(c_config::get().custom_yaw_stand, 0, "Aimbot", "custom_yaw_stand");
	SetupValue(c_config::get().custom_pitch_stand, 0, "Aimbot", "custom_pitch_stand");
	SetupValue(c_config::get().spin_speed_stand, 0, "Aimbot", "spin_speed_stand");

	SetupValue(c_config::get().pitch_moving, 0, "Aimbot", "pitch_moving");
	SetupValue(c_config::get().yaw_moving, 0, "Aimbot", "yaw_moving");
	SetupValue(c_config::get().yaw_moving_add, 0, "Aimbot", "yaw_moving_add");
	SetupValue(c_config::get().custom_yaw_move, 0, "Aimbot", "custom_yaw_move");
	SetupValue(c_config::get().custom_pitch_move, 0, "Aimbot", "custom_pitch_move");
	SetupValue(c_config::get().spin_speed_move, 0, "Aimbot", "spin_speed_move");
	SetupValue(c_config::get().yaw_moving_add_angle, 0, "Aimbot", "yaw_moving_add_angle");

	SetupValue(c_config::get().pitch_air, 0, "Aimbot", "pitch_air");
	SetupValue(c_config::get().yaw_air, 0, "Aimbot", "yaw_air");
	SetupValue(c_config::get().yaw_air_add, 0, "Aimbot", "yaw_air_add");
	SetupValue(c_config::get().yaw_air_add_angle, 0, "Aimbot", "yaw_air_add_angle");
	SetupValue(c_config::get().custom_yaw_air, 0, "Aimbot", "custom_yaw_air");
	SetupValue(c_config::get().custom_pitch_air, 0, "Aimbot", "custom_pitch_air");
	SetupValue(c_config::get().spin_speed_air, 0, "Aimbot", "spin_speed_air");


	SetupValue(c_config::get().fakelag, 0, "Aimbot", "fakelag");
	SetupValue(c_config::get().variance, 0, "Aimbot", "variance");
	SetupValue(c_config::get().fakeduck_test, 0, "Aimbot", "fakeduck");
	...
	SetupValue(c_config::get().desync_add, 0, "Aimbot", "desync_add");
	...
	*/
	...
	SetupValue(c_config::get().draw_spread, false, "Visuals", "draw_spread");
	...
	SetupValue(c_config::get().desync_chams, false, "Visuals", "desync_chams");
	...
	SetupValue(c_config::get().desync_chams_color_r, 255, "Visuals", "desync_chams_color_r");
	SetupValue(c_config::get().desync_chams_color_g, 255, "Visuals", "desync_chams_color_g");
	SetupValue(c_config::get().desync_chams_color_b, 255, "Visuals", "desync_chams_color_b");
	SetupValue(c_config::get().desync_chams_color_a, 255, "Visuals", "desync_chams_color_a");
	...
	SetupValue(c_config::get().lefthandknife, false, "Misc", "lefthandknife");
	SetupValue(c_config::get().metalworld, false, "Misc", "metalworld");
	SetupValue(c_config::get().bullet_tracer, false, "Misc", "bullet_tracer");
	SetupValue(c_config::get().capsule, false, "Misc", "capsule");
	SetupValue(c_config::get().misc_keystrokes, false, "Misc", "misc_keystrokes");
	SetupValue(c_config::get().customviewmodel, false, "Misc", "customviewmodel");

	SetupValue(c_config::get().ViewmodelX, -1, "Misc", "ViewmodelX");
	SetupValue(c_config::get().ViewmodelY, -1, "Misc", "ViewmodelY");
	SetupValue(c_config::get().ViewmodelZ, -1, "Misc", "ViewmodelZ");
	SetupValue(c_config::get().capsuleduration, -1, "Misc", "capsuleduration");
	SetupValue(c_config::get().fakelagspoof, -1, "Misc", "fakelagspoof");
	SetupValue(c_config::get().thirdperson_bind, -1, "Misc", "thirdperson_bind");
	SetupValue(c_config::get().fakeduck_bind, -1, "Misc", "fakeduck_bind");
