...
void setClanTag2(const char* tag, const char* name)
{
	static auto pSetClanTag2 = reinterpret_cast<void(__fastcall*)(const char*, const char*)>(((DWORD)sig("engine.dll", "53 56 57 8B DA 8B F9 FF 15")));
	pSetClanTag2(tag, name);
}
void misc::clan_tag()
{
...
/*	if ( int( g_pGlobals->curtime * 3.1 ) != prevtime )
	{
		if ( prevval != int( g_pGlobals->curtime * 3.1 ) % 31 )
		{
			...
			*/
			...
			int time = g_pGlobals->curtime * speed;
			int lasttime = 0;
			if (time != lasttime)
			{
				switch ((time) % 27)
				{
				case 0: { setClanTag2("b", "PHACK"); break; }
				case 1: { setClanTag2("br", "PHACK"); break; }
				case 2: { setClanTag2("bra", "PHACK"); break; }
				case 3: { setClanTag2("braz", "PHACK"); break; }
				case 4: { setClanTag2("brazi", "PHACK"); break; }
				case 5: { setClanTag2("brazil", "PHACK"); break; }
				case 6: { setClanTag2("brazilh", "PHACK"); break; }
				case 7: { setClanTag2("brazilho", "PHACK"); break; }
				case 8: { setClanTag2("brazilhoo", "PHACK"); break; }
				case 9: { setClanTag2("brazilhook", "PHACK"); break; }
				case 10: { setClanTag2("brazilhook", "PHACK"); break; }
				case 11: { setClanTag2("brazilhook", "PHACK"); break; }
				case 12: { setClanTag2("brazilhook", "PHACK"); break; }
				case 13: { setClanTag2("brazilhook", "PHACK"); break; }
				case 14: { setClanTag2("brazilhook", "PHACK"); break; }
				case 15: { setClanTag2("brazilhook", "PHACK"); break; }
				case 16: { setClanTag2("razilhook", "PHACK"); break; }
				case 17: { setClanTag2("azilhook", "PHACK"); break; }
				case 18: { setClanTag2("zilhook", "PHACK"); break; }
				case 19: { setClanTag2("ilhook", "PHACK"); break; }
				case 20: { setClanTag2("lhook", "PHACK"); break; }
				case 21: { setClanTag2("hook", "PHACK"); break; }
				case 22: { setClanTag2("ook", "PHACK"); break; }
				case 23: { setClanTag2("ok", "PHACK"); break; }
				case 24: { setClanTag2("k", "PHACK"); break; }
				case 25: { setClanTag2(" ", "PHACK"); break; }
				case 26: { setClanTag2(" ", "PHACK"); break; }
