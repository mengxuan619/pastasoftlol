...
std::uint8_t* util::PatternScan(void* module, const char* signature)
{
...
unsigned int util::FindPattern(std::string moduleName, std::string pattern, bool relativeOffset)
{
