...
public:
	...
	VFUNC( 17, get_pred_desc_map(), datamap_t*( __thiscall * )( void* ) )( )
		...
		NETVAR(get_mins, Vector, "CBaseEntity", "m_vecMins")
		NETVAR(get_maxs, Vector, "CBaseEntity", "m_vecMaxs")
...
public:
	...
	NETVAR( get_eye_angles, QAngle, "CCSPlayer->m_angEyeAngles" )
		NETVAR(get_eye_angles23, Vector, "CCSPlayer->m_angEyeAngles")
	...
	APOFFSET( get_anim_layers, C_AnimationLayer, 15, 0x2980)
		...
		OFFSET(get_pose_parameter2, CCSGOAnimStatePoses, 0x2774)
		OFFSET(get_animation_layers2, animation_layers*, 0x2980)

	int GetNumAnimOverlays()
	{
		return *(int*)((DWORD)this + 0x298C); // 0x298C
	}
	QAngle* GetEyeAnglesXY_xyo()
	{
		//return reinterpret_cast<QAngle*>((DWORD)this + 0xB344);
		return (QAngle*)((DWORD)this + 0xB344);
	}
	C_AnimationLayer* AnimOverlays3()
	{
		return *reinterpret_cast<C_AnimationLayer**>(uintptr_t(this) + 0x2980);
		//return *(int*)((DWORD)this + 0x298C); // 0x298C
	}
	C_AnimationLayer* get_anim_overlay_index(int i)
	{
		if (i < 15)
			return &AnimOverlays3()[i];
		return nullptr;
	}
	...
	{
		static int m_bClientSideAnimation = get_clientside_animation();
		*reinterpret_cast<bool*>(uintptr_t(this) + m_bClientSideAnimation) = value;
	}

	void setAnimationState(CCSGOPlayerAnimState* state) {
		*reinterpret_cast<CCSGOPlayerAnimState**>(uintptr_t(this) + 0x3884) = state;
	}
	...
	VFUNC(223, update_clientside_anim(), void(__thiscall*)(C_CSPlayer*))()
